...
export const SupportInfo = () => {
  return (
    <div className="storybook-welcome">
      ...
      <div>
        <p>
          <strong>Found a bug or have an idea for an enhancement?</strong> File a new issue{' '}
          <a href="https://github.com/carbon-design-system/carbon-addons-iot-react/issues/new/choose">
            here
          </a>
        </p>
        <p>
          <strong>Need some help?</strong> If you're an IBMer, join{' '}
          <a href="https://ibm-ai-apps.slack.com/archives/CDD01SREX">#ai-apps-pal</a> for questions
          about the Watson IoT Pattern and Asset Library (PAL) and{' '}
          <a href="https://ibm-ai-apps.slack.com/archives/CMYHKU8HZ">#ai-apps-pal-components</a> for
          questions about components. Otherwise, post your question to our github{' '}
          <a href="https://github.com/carbon-design-system/carbon-addons-iot-react/issues/new?assignees=&labels=type%3A+question+%3Agrey_question%3A%2C+status%3A+needs+triage+%3Amag%3A&template=question.md&title=%5BComponentName%5D+question_title%3F">
            here
          </a>
          .
        </p>
        <p>
          <strong>Interested in contributing to the project?</strong>{' '}
          <a href="https://github.com/carbon-design-system/carbon-addons-iot-react/blob/next/.github/CONTRIBUTING.MD">
            Here's
          </a>{' '}
          how to get started.
        </p>
