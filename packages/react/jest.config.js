module.exports = {
  ...
  coverageThreshold: {
    ...
    './src/components/**/!(FilterHeaderRow|RowActionsCell|RowActionsError|TableHead|StatefulTable|StatefulTableDetailWizard|TableHead|TimeSeriesCard|BarChartCard|DashboardGrid|DashboardEditor).jsx': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
