...
describe('valueCardUtils', () => {
  describe('determineLayout', () => {
    it('should return horizontal layout', () => {
      ...
      expect(determineLayout(CARD_SIZES.SMALLWIDE)).toBe(
        CARD_LAYOUTS.HORIZONTAL
      );
      expect(determineLayout('some unsupported card size')).toBe(
        CARD_LAYOUTS.HORIZONTAL
      );
    });
    ...
    it('should return vertical layout', () => {
      ...
      expect(determineLayout(CARD_SIZES.MEDIUMTHIN)).toBe(
        CARD_LAYOUTS.VERTICAL
      );
      expect(determineLayout(CARD_SIZES.MEDIUMWIDE)).toBe(
        CARD_LAYOUTS.VERTICAL
      );
