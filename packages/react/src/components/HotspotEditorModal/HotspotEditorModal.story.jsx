...
export const WidthSharedThresholds = () => {
  const myCardConfig = {
    ...cardConfig,
    values: {
      ...cardConfig.values,
...
WidthSharedThresholds.story = {
  name: 'With shared thresholds in cardConfig.thresholds ',
  parameters: {
    info: {
      text: `If the cardConfig has a thresholds array prop then this component will
      export the thresholds there instead of per hotspot. This will mean that all hotspots 
      using the same data source will share the thresholds of that data source.`,
      propTables: [HotspotEditorModal],
    },
  },
};
