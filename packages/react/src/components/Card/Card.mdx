...
You can use extraActions on a Card. Which can be used in the card toolbar to either display a single icon with a unique action, a three-dot icon with many custom actions inside of it, or even a custom component.
...
```jsx
// Card with extra action custom elements
<Card
  {...cardProps}
  size={CARD_SIZES.LARGE}
  availableActions={{
  ...
  extraActions={[{ id: 'idItem', content: <div>custom element</div> }]}
/>
```
...
| extraActions                     | shape, array                                                                                                                                          |                                                                           | extra action object to either display single icon, array of items to be displayed as overflow items, or array with custom content.                                                                |
| overrides                        | shape                                                                                                                                                 |                                                                           | allow overriding the component used in Error and Empty states                                                                                                                                     |
| overrides.errorMessage           | shape                                                                                                                                                 |                                                                           |                                                                                                                                                                                                   |
| overrides.errorMessage.component | Element                                                                                                                                               |                                                                           | By default this is the PAL EmptyState component. The title, body, and icon are passed to this element to be render either an empty or error state                                                 |
| overrides.errorMessage.props     | shape                                                                                                                                                 |                                                                           | These are the same props accepted by the EmptyState component. See its [docs for more information](https://next.carbon-addons-iot-react.com/?path=/docs/1-watson-iot-emptystate--first-time-use). |
| i18n                             | shape                                                                                                                                                 |                                                                           |                                                                                                                                                                                                   |
...
| titleTextTooltip                 | element                                                                                                                                               | undefined                                                                 | Adds tooltip to the title (no info icon) that when clicked shows a tooltip with this content. Cannot be used together with the tooltip prop or the or the hasTitleWrap prop.                      |
| tooltip                          | element                                                                                                                                               | undefined                                                                 | Adds an info icon after the title that when clicked shows a tooltip with this content. Cannot be used together with the titleTextTooltip prop                                                     |
