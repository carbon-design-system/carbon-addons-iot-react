...
describe('MenuButton', () => {
  ...
  it('should render secondary kind for single button and split button', () => {
    // Single button
  ...
  it('should show the shadow-blocker div on a ghost button without a label', () => {
    render(
      <MenuButton onPrimaryActionClick={callbacks.primary} kind="ghost">
        {menuItems}
      </MenuButton>
    );
    ...
    expect(document.body.querySelector(`.${prefix}--menu`)).toHaveClass(`${prefix}--menu--open`);
    expect(document.body.querySelector(`.${iotPrefix}--menu__shadow-blocker`)).toBeVisible();
  });
