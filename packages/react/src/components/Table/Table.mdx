...
representing the toolbarActions and these will be rendered dynamically
...
| toolbar.onApplyExtraAction      | func   |         | Fired when clicking on toolbarActions in the table toolbar                                                                                                                                                      |
| table                           | object |         |                                                                                                                                                                                                                 |
