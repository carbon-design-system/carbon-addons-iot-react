...
You can add other actions to the toolbar overflow menu by using the extraActions prop on the view.toolbar.
When clicking on an action it will trigger the `onApplyExtraAction` callback passing the object
used to create the action. If `extraActions` is a function, it can return an array of objects
representing the extraActions and these will be rendered dynamically
...
<Table
  ...
  actions={{
    toolbar: {
      onApplyExtraAction: (actionObject) => {},
    },
  }}
  view={{
    toolbar: {
...
| toolbar.extraActions                             | arrayOf(object)                  |                                                                                                  | An array of objects for adding actions to the overflow menu in the toolbar                                                                          |
| toolbar.extraActions[].id                        | string                           |                                                                                                  | the id of this action                                                                                                                               |
| toolbar.extraActions[].labelText                 | string                           |                                                                                                  | The text to display in the overflow menu                                                                                                            |
| toolbar.extraActions[].hidden                    | bool                             |                                                                                                  | This will hide this item from the menu                                                                                                              |
| toolbar.extraActions[].disabled                  | bool                             |                                                                                                  | This will show the item, but it will be disabled                                                                                                    |
| toolbar.extraActions[].isDelete                  | bool                             |                                                                                                  | Show the item, and turn the background red on hover                                                                                                 |
| toolbar.extraActions[].hasDivider                | bool                             |                                                                                                  | Show a divider at the top of this action item                                                                                                       |
| toolbar.extraActions[].renderIcon                | node, func, string               | Can be a string of a handful of included icons, a function to render an icon, or an icon element |
| table                                            | object                           |                                                                                                  |                                                                                                                                                     |
...
| toolbar.onApplyExtraAction      | func   |         | Fired when clicking on extraActions in the table toolbar                                                                                                                                                        |
| table                           | object |         |                                                                                                                                                                                                                 |
