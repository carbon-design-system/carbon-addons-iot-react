...
When clicking on an action it will trigger the onApplyExtraActions callback passing the object
...
<Table
  ...
  actions={{
    toolbar: {
      onApplyExtraActions: (actionObject) => {},
    },
  }}
  view={{
    toolbar: {
...
| toolbar.onApplyExtraActions     | func   |         | Fired when clicking on extraActions in the table toolbar                                                                                                                                                        |
| table                           | object |         |                                                                                                                                                                                                                 |
