...
| table.anticipatedMultiSortColumn           | object                           | undefined | An object containing {columnId, direction} of the column that multi-sort was initiated on                                                           |
| table.anticipatedMultiSortColumn.columnId  | string                           | undefined | The columnId of the column multi-sort was initiated on. This is to automatically select it in the modal                                             |
| table.anticipatedMultiSortColumn.direction | 'ASC' or 'DESC'                  | undefined | The default direction for this column selected                                                                                                      |
