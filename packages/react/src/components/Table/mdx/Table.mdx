...
import PinnedColumn from './PinnedColumn.mdx';
...
| pinColumn                   | 'none', 'first', 'last' .                                | 'none'   | Can freeze the 'first' or 'last' column regardless of horizontal scroll position. Default is 'none'.                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| toolbarSearchIconDescription     | string       | 'Search'                 | Search tooltip label displayed on hover                |
