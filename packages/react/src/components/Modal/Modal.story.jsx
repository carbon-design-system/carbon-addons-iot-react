  ...
  return (
    <Modal {...rest} size={size || undefined}>
      <p className={`${prefix}--modal-content__text`}>
        Please see the &quot;With State Manager&quot; storybook example for a demo of this
        functionality.
      </p>
      <br />
...
export const WithStateManager = () => {
  ...
  return (
    <ModalStateManager
      renderLauncher={({ setOpen }) => <Button onClick={() => setOpen(true)}>Launch modal</Button>}
    >
      {({ open, setOpen }) => (
        <Modal {...rest} size={size || undefined} open={open} onRequestClose={() => setOpen(false)}>
          {rest.hasScrollingContent && (
            <>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean id accumsan augue.
...
export const TitleOnly = () => {
  ...
  return <Modal {...rest} size={size || undefined} />;
};
