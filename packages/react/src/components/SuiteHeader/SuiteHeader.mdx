...
the label of each function and allow you to determine if it should be rendered or not.
...
| isActionItemVisible                                  | function | () => true                        | Is passed the label of the item being rendered and returns a boolean if it should be in the DOM. (label) => {}                                              |
