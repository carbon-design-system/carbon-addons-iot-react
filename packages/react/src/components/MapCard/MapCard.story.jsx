...
export const MapBoxCard = () => (
  <MapBoxStory data={data} options={options} isLegendFullWidth={boolean('isLegendFullWidth', false)} onCardAction={() => action('card action clickety clacked')}/>
);

export const OpenlayersExample = () => (
  <OpenLayersStory data={data} options={options} isLegendFullWidth={boolean('isLegendFullWidth', false)} onCardAction={() => action('card action clickety clacked')}/>
);
