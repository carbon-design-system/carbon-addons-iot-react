...
describe('componentUtilityFunctions', () => {
  ...
  it('getLayout should generate new a layout for each card', () => {
    // Current breakpoint
    const layoutName = 'lg';
    const cards = [
    ...
    const layout = getLayout(layoutName, cards, DASHBOARD_COLUMNS, CARD_DIMENSIONS, existingLayout);
  ...
  it('getLayout should throw a console.error if layout is bad', () => {
