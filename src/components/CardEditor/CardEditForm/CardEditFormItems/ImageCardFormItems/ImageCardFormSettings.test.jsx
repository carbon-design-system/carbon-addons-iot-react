...
describe('ImageCardFormSettings', () => {
  ...
  it('returns an object with the right color token', () => {
    expect(backGroundColor('#f4f4f4')).toEqual({ "carbonColor": "#f4f4f4", "name": "gray10" });
    expect(backGroundColor('#ffffff')).toEqual({ "carbonColor": "#ffffff", "name": "white" });
    expect(backGroundColor('#393939')).toEqual({ "carbonColor": "#393939", "name": "gray80" });
  });
