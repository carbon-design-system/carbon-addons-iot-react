...
SinglePoint.storyName = 'single point';
...
WithVariables.storyName = 'with variables';
...
MediumSingleLineIntervalHour.storyName = 'medium / single line - interval hour';
...
MultiLineNoXYLabel.storyName = 'multi line - (No X/Y Label)';
...
MediumSingleLineIntervalMonthYearSameYear.storyName = 'medium / single line - interval month (Year/ Same Year)';
...
MediumMultipleLineIntervalMonthYearSameYear.storyName = 'medium / multiple line - interval month (Year/ Same Year)';
...
MediumSingleLineIntervalYearTwoDataPoint.storyName = 'medium / single line - interval year (Two data point)';
...
MediumMultiLineNoXYLabel.storyName = 'medium / multi line - (No X/Y Label)';
...
LargeSingleLineIntervalHourSameDay.storyName = 'large / single line - interval hour (Same day)';
...
LargeSingleLineIntervalDayWeek.storyName = 'large / single line - interval day (Week)';
...
LargeSingleLineIntervalDayMonth.storyName = 'large / single line - interval day (Month)';
...
LargeSingleLineIntervalMonthYearDiffYear.storyName = 'large / single line - interval month (Year/ Diff Year)';
...
LargeSingleLineYearIntervalOneDataPoint.storyName = 'large / single line - year interval (One data point)';
...
LargeMultiLineNoInterval.storyName = 'large / multi line - no interval';
...
LargeUnits.storyName = 'large / units';
...
WithZoomBar.storyName = 'with zoomBar';
...
DomainRange.storyName = 'domainRange';
...
HighlightAlertRanges.storyName = 'highlight alert ranges';
...
EmptyForARange.storyName = 'empty for a range';
...
LotsOfDots.storyName = 'lots of dots';
...
IsExpanded.storyName = 'isExpanded';
...
DataFilter.storyName = 'dataFilter';
