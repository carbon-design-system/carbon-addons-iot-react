...
TableWithMultipleActions.storyName = 'table with multiple actions';
...
WithRowSpecificLinkVariables.storyName = 'With row specific link variables';

WithRowSpecificLinkVariables.parameters = {
  info: {
...
TableWithSingleActions.storyName = 'table with single actions';
...
TableWithThresholdsPrecisionAndExpandedRows.storyName = 'table with thresholds, precision and expanded rows';
...
WithDynamicVariables.storyName = 'With dynamic variables';

WithDynamicVariables.parameters = {
  info: {
    text: ` # Passing variables
...
TableWithThresholds.storyName = 'table with thresholds';

TableWithThresholds.parameters = {
  info: {
    text: `
...
TableWithThresholdsOnlyWithIcon.storyName = 'table with thresholds only with icon';

TableWithThresholdsOnlyWithIcon.parameters = {
  info: {
    text: `
...
TableWithCustomColumnSort.storyName = 'table with custom column sort';
...
TableWithFixedColumnSize.storyName = 'table with fixed column size';
...
TableWithRowExpansion.storyName = 'table with row expansion';
...
TableWithRowExpansionAndLinkVariables.storyName = 'table with row expansion and link variables';

TableWithRowExpansionAndLinkVariables.parameters = {
  info: {
    text: ` # Passing variables
  To pass a variable into your card, identify a variable to be used by wrapping it in curly brackets.
  Make sure you have added a prop called 'cardVariables' to your card that is an object with key value pairs such that the key is the variable name and the value is the value to replace it with.
...
TableWithRowExpansionAndRowSpecificLinkVariables.storyName = 'table with row expansion and row specific link variables';

TableWithRowExpansionAndRowSpecificLinkVariables.parameters = {
  info: {
    text: ` # Passing variables
  To pass a variable into your card, identify a variable to be used by wrapping it in curly brackets.
  Make sure you have added a prop called 'cardVariables' to your card that is an object with key value pairs such that the key is the variable name and the value is the value to replace it with.
...
EditableWithExpandedRows.storyName = 'editable with expanded rows';
