...
DefaultWithKnobs.storyName = 'Default with knobs';

DefaultWithKnobs.parameters = {
  info: {
    text: `
...
CustomDescriptionAndPublicCheckboxUsingOverrides.storyName = 'Custom description and public checkbox (using overrides)';

CustomDescriptionAndPublicCheckboxUsingOverrides.parameters = {
  info: {
    text: `
    This story demonstrates how to customise parts of the TableSaveViewModal internals, 
    i.e. the description and the publicCheckbox. 
...
CustomFormUsingOverrides.storyName = 'Custom form (using overrides)';

CustomFormUsingOverrides.parameters = {
  info: {
    text: `
  This story demonstrates how to change the complete form of the modal using the overrides pattern. 
