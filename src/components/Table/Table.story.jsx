...
StatefulExampleWithEveryThirdRowUnselectable.storyName = 'Stateful Example with every third row unselectable';
...
StatefulExampleWithExpansionMaxPagesAndColumnResize.storyName = 'Stateful Example with expansion, maxPages, and column resize';
...
StatefulExampleWithPreSetMultiselectFiltering.storyName = 'Stateful Example with pre-set multiselect filtering';
...
StatefulExampleWithRowNestingAndFixedColumns.storyName = 'Stateful Example with row nesting and fixed columns';
...
StatefulExampleWithSingleNestedHierarchy.storyName = 'Stateful Example with single nested hierarchy';
...
WithMultiSelectAndBatchActions.storyName = 'with multi select and batch actions';
...
WithSingleSelect.storyName = 'with single select';
...
WithSingleSelectAndNestedTableRows.storyName = 'with single select and nested table rows ';
...
WithRowExpansionAndOnRowClickExpands.storyName = 'with row expansion and on row click expands';
...
WithRowExpansionAndActions.storyName = 'with row expansion and actions';
...
WithNestedTableRows.storyName = 'with nested table rows';
...
WithNoDataAndCustomEmptyState.storyName = 'with no data and custom empty state';
...
WithZebraStriping.storyName = 'with zebra striping';
...
WithResizeAndInitialColumnWidthsOnSimpleStatefulWithRowSelectionSort.storyName = 'with resize and initial column widths on Simple Stateful with row selection & sort';
...
WithResizeAndInitialColumnWidthsAndHiddenColumn.storyName = 'with resize and initial column widths and hidden column';
...
WithResizeHasColumnSelectionAndInitialColumnWidths.storyName = 'with resize, hasColumnSelection and initial column widths';
...
WithResizeOnColumnResizeCallbackNoInitialColumnWidthAndColumnManagement.storyName = 'with resize, onColumnResize callback, no initial column width and column management';
...
WithResizeAndNoInitialColumnWidthAndAutoAdjustedColumnWidths.storyName = 'with resize and no initial column width and auto adjusted column widths';
...
WithResizeAndNoInitialColumns.storyName = 'with resize and no initial columns';
...
WithLightweightDesign.storyName = 'with lightweight design';
...
FilteredSortedPaginatedTableWithAsynchronousDataSource.storyName = 'Filtered/Sorted/Paginated table with asynchronous data source';
...
WithStickyHeaderExperimentalAndCellTooltipCalculation.storyName = 'with sticky header (experimental) and cell tooltip calculation';
...
SimpleStatefulExampleWithColumnOverflowMenu.storyName = 'Simple Stateful Example with column overflow menu';
