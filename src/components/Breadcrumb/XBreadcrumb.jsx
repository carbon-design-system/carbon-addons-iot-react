/**
 *  1. H use sass instead of `style-components`
 *  2. H remove carbon-grid, use multi-media
 *  3. E {...other} means all the props come from carbon component
 *  4. E descrip name for t line 59
 *  5. M ellipsis character instead of icon
 *  6. M a11y support
 *  7. E ${prefix} in classname
 *  👌8. E storybook include all stories from `Carbon core`, add additional ones new.
 *  9. H flexible container according to browser width.
 *  10. judge BreadcrumbItem length
 */
...
const StyledOverflowMenu = styled(OverflowMenu)`
  ...
  margin-right: 0.5rem;
`;
// TODO: target tap should be 3x3em(48x48px)
