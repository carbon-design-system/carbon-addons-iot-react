...
SmallBasic.storyName = 'small / basic';
...
SmallWithExpand.storyName = 'small / with expand';
...
SmallWithVariables.storyName = 'small / with variables';

SmallWithVariables.parameters = {
  info: {
    text: `
  # Passing variables
...
SmallLong.storyName = 'small / long';
...
SmallWrapping.storyName = 'small / wrapping';

SmallWrapping.parameters = {
  info: {
    text:
...
SmallWrappingNoUnits.storyName = 'small / wrapping no units';

SmallWrappingNoUnits.parameters = {
  info: {
    text:
...
SmallTrendDown.storyName = 'small / trend down';
...
SmallTrendUp.storyName = 'small / trend up';
...
SmallThresholdsNumberNoIcon.storyName = 'small / thresholds (number, no icon)';
...
SmallThresholdsNumberIcon.storyName = 'small / thresholds (number, icon)';
...
SmallThresholdsNumberCustomRenderIconByName.storyName = 'small / thresholds (number, custom renderIconByName)';
...
SmallwideThresholdsString.storyName = 'smallwide / thresholds (string)';
...
SmallwideVertical2.storyName = 'smallwide / vertical 2';
...
SmallwideHorizontal2.storyName = 'smallwide / horizontal 2';
...
MediumVerticalSingle.storyName = 'medium / vertical / single';
...
MediumVerticalMultiple.storyName = 'medium / vertical / multiple';
...
MediumVertical2.storyName = 'medium / vertical /  2';
...
MediumthinVertical3.storyName = 'mediumthin / vertical /  3';
...
MediumHorizontal2.storyName = 'medium / horizontal /  2';
...
MediumHorizontal3.storyName = 'medium / horizontal /  3';
...
LargeVertical5.storyName = 'large / vertical /  5';
...
LargeThinVertical6.storyName = 'large-thin / vertical /  6';
...
MediumWideHorizontal3.storyName = 'medium-wide / horizontal /  3';
...
WithBoolean.storyName = 'with boolean';
...
DataStateNoDataMediumScrollPage.storyName = 'data state - no data - medium - scroll page';
...
DataStateNoDataCustomIconLarge.storyName = 'data state - no data - custom icon - large';
...
DataStateErrorMedium.storyName = 'data state - error - medium';
...
DataStateErrorSmall.storyName = 'data state - error - small';
...
DataStateErrorSmallTooltipDirectionRight.storyName = 'data state - error - small - tooltip direction right';
...
LongTitlesAndValues.storyName = 'long titles and values';
...
LongTitlesAndValuesMultiple.storyName = 'long titles and values/multiple';
...
DataFilters.storyName = 'dataFilters';
