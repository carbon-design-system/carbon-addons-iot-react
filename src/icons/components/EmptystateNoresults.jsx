...
function SvgEmptystateNoresults(props) {
  return (
    <svg width={80} height={80} {...props}>
      <defs>
        <linearGradient
          ...
          x2="63.844%"
          y2="82.272%"
          id="emptystate-Noresults_svg__a">
        ...
        <linearGradient
          ...
          x2="-5.873%"
          y2="49.937%"
          id="emptystate-Noresults_svg__b">
        ...
        <linearGradient
          ...
          x2="57.71%"
          y2="37.165%"
          id="emptystate-Noresults_svg__d">
        ...
        <linearGradient
          ...
          x2="100%"
          y2="49.899%"
          id="emptystate-Noresults_svg__f">
        ...
        <linearGradient
          ...
          x2="100%"
          y2="49.986%"
          id="emptystate-Noresults_svg__g">
        ...
        <linearGradient
          ...
          x2="60.593%"
          y2="-.766%"
          id="emptystate-Noresults_svg__h">
        ...
        <linearGradient
          ...
          x2="67.107%"
          y2="4.635%"
          id="emptystate-Noresults_svg__i">
        ...
        <linearGradient
          ...
          x2="106.485%"
          y2="107.052%"
          id="emptystate-Noresults_svg__j">
        ...
        <linearGradient
          ...
          x2="55.132%"
          y2="109.429%"
          id="emptystate-Noresults_svg__k">
        ...
        <linearGradient
          ...
          x2="36.716%"
          y2="44.266%"
          id="emptystate-Noresults_svg__l">
        ...
        <linearGradient
          ...
          x2="64.466%"
          y2="-1.425%"
          id="emptystate-Noresults_svg__m">
        ...
        <radialGradient
          ...
          id="emptystate-Noresults_svg__c">
        ...
        <radialGradient
          ...
          id="emptystate-Noresults_svg__e">
          <stop stopColor="#FFF" stopOpacity={0} offset="12%" />
      ...
      <g fillRule="nonzero" fill="none">
        ...
        <path
          ...
          fill="url(#emptystate-Noresults_svg__a)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__b)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__c)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__d)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__e)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__f)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__g)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__h)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__i)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__j)"
        ...
        <path
          ...
          fill="url(#emptystate-Noresults_svg__k)"
        />
        <path
          ...
          transform="translate(2.807 12.617)"
          fill="url(#emptystate-Noresults_svg__l)"
        />
        <path
          ...
          fill="url(#emptystate-Noresults_svg__m)"
        />
      </g>
    </svg>
  );
...
export default SvgEmptystateNoresults;
