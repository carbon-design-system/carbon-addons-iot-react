    ...
    <svg width={40} height={32} {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g transform="translate(21 13.714)">
          <use fill="#0F62FE" xlinkHref="#alert-table_svg__a" />
          <use fill="#FFF" xlinkHref="#alert-table_svg__b" />
        </g>
      </g>
    </svg>
  );
