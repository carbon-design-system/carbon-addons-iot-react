...
function SvgEmptystateError(props) {
  return (
    <svg width={80} height={80} {...props}>
      ...
      <g fillRule="nonzero" fill="none">
        <path
          ...
          fill="url(#emptystate-Error_svg__a)"
        ...
        <path
          ...
          fill="url(#emptystate-Error_svg__b)"
        />
        <path
          ...
          transform="translate(19.333 3.333)"
          fill="url(#emptystate-Error_svg__c)"
        />
        <path
          ...
          fill="url(#emptystate-Error_svg__d)"
        />
        <path
        ...
        <path
          ...
          fill="url(#emptystate-Error_svg__h)"
        />
        <path
...
export default SvgEmptystateError;
