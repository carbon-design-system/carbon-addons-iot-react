...
function SvgEmptystateSuccess(props) {
  return (
    <svg width={80} height={80} {...props}>
      ...
      <g fillRule="nonzero" fill="none">
        ...
        <path
          ...
          fill="url(#emptystate-Success_svg__a)"
          transform="translate(9)"
        />
        <path
          fill="url(#emptystate-Success_svg__b)"
          d="M8.728 12.733l-1.203 3.48 1.203-.671z"
          transform="translate(9)"
        />
        <path
          fill="url(#emptystate-Success_svg__c)"
        ...
        <path
          ...
          fill="url(#emptystate-Success_svg__d)"
          transform="translate(9)"
        />
        <path
...
export default SvgEmptystateSuccess;
